...
public class RestaurantController {
	...
	@RequestMapping(value="restaurants"+"/{"+"restaurantId"+"}",method=RequestMethod.GET,produces=MediaType.APPLICATION_STREAM_JSON_VALUE)
	...
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value="restaurants",method=RequestMethod.GET,produces=MediaType.APPLICATION_STREAM_JSON_VALUE)
	public BookingResponse<List<RestaurantRest>> gestRestaurants() throws BookingException {
